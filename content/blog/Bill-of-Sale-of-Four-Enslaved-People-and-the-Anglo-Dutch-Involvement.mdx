...
## Referenced Items
---
<section class="referenced-items"><div class="referenced-items__grid" role="list"><div class="referenced-items__item" role="listitem"><a href="https://bcb2507.github.io/newtest/works/financial-record-with-notation-and-seal.html" class="canopy-card referenced-items__card" data-aspect-ratio="1.3107696566998892" data-in-view="true" data-image-loaded="true"><figure><div class="canopy-card-media" style="--canopy-card-padding:76.2910550216496%"><img src="https://sites.dlib.nyu.edu/viewer/api/presentation/photos/fales_mss208_cuid4771/manifest.json" alt=“handwritten document” loading="lazy"/></div><figcaption><span>Financial Record with Notation & Seal: 1687 September 20</span></figcaption></figure></a></div>
---
<ReferencedItems />
